...
// Environment variables can be set via PowerShell: $env:MNEMONIC="your mnemonic"
...
const config: HardhatUserConfig = {
  ...
  etherscan: {
    apiKey: {
      // Support ETHERSCAN_API_KEY via environment variable or hardhat vars
  ...
  networks: {
    ...
    sepolia: {
      ...
      chainId: 11155111,
      // Use custom RPC URL if provided via SEPOLIA_RPC_URL environment variable,
      // otherwise fall back to Infura
